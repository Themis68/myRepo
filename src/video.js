...
function switchVideo(n) {
	...
	if (n > arrayAssoSize(scenario)) {
        ...
        if (isDefineBVideoJS) {
			...
			gestionCamps(0);	// MAJ des infos des équipes

			/*myVideo.options_.plugins.bug[0].imgSrc = {
				name: "BugComponent",
				type: "pict",
			...
			myVideo.options_.plugins.bug[1] = {
				name: "BugComponent",
				type: "text",
			...
			myVideo.options_.plugins.bug[2] = {
				name: "BugComponent",
				type: "canvas",
			...
			myVideo.options_.plugins.bug[3] = {
				name: "BugComponent",
				type: "canvas",
			...
			myVideo.options_.plugins.bug[4] = {
				name: "BugComponent",
				type: "text",
			...
			myVideo.options_.plugins.bug[5] = {
				name: "BugComponent",
				type: "canvas",
			...
			myVideo.options_.plugins.bug[6] = {
				name: "BugComponent",
				type: "text",
			...
			myVideo.options_.plugins.bug[7] = {
				name: "BugComponent",
				type: "pict",
		...
		console.log(myVideo.options_.plugins.bug[0]);
...
function gestionCamps(mitemps) {
	...
	if (mitemps===0) {
		...
		draw("vjs-bug-silhEquipeA", video[0].gauche.maillotCouleur);
		draw("vjs-bug-silhEquipeB", video[0].droite.maillotCouleur);
		draw("vjs-bug-silhEquipeB", video[0].arbitre.maillotCouleur);
	}
	if (mitemps===2) {
