...
function header() {
	...
	myHeader+='<a href="'+ url + '/indexDK.html">';
...
function footer() {
    ...
    myFooter+='<div class="col-lg-2 col-md-2 col-sm-2">';
    myFooter+='<span><a href="'+url+'/lois/lois.html">Lois</a></span>';
    myFooter+='</div>';

    myFooter+='<div class="col-lg-2 col-md-2 col-sm-2">';
	myFooter+='<span><a href="mailto:arretsurimage_@laposte.net?Subject=Prise de contact sur Arrêt sur image!" target="_blank">';
	myFooter+='contact <i class="fas fa-envelope"></i>';
    myFooter+='</a></span>';
    myFooter+='</div>';
